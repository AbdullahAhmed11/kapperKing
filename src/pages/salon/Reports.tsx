...
function Reports() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setMetricsData([
          { name: 'Revenue', value: '€19,200', change: '+12.5%', trend: 'up', icon: DollarSign, color: 'from-primary-500 to-primary-600' },
          { name: 'New Clients', value: '145', change: '+8.2%', trend: 'up', icon: Users, color: 'from-pink-500 to-pink-600' },
          { name: 'Average Service Value', value: '€75', change: '+5.4%', trend: 'up', icon: TrendingUp, color: 'from-indigo-500 to-indigo-600' },
          { name: 'Appointments', value: '384', change: '-2.1%', trend: 'down', icon: Calendar, color: 'from-purple-500 to-purple-600' }
        ]);
        setRevenueChartData([
    ...
    fetchData();
  }, [selectedRange]); // Refetch when selectedRange changes
  ...
  return (
    ...
    </div> // Closes the main div from line 158
