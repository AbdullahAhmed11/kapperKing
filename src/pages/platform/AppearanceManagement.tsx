...
export default function AppearanceManagement() {
  ...
  if ( !colorPalette || !marketingHeader) {
...
// import React, { useRef, useState, useEffect } from 'react';
// import { Palette, Image, Paintbrush, Type, Layout as LayoutIcon, } from 'lucide-react'; 
// import { Button } from '@/components/ui/button';
// import { Input } from '@/components/ui/input';
// import { Label } from '@/components/ui/label';
// import { toast } from 'sonner'; 
...
//   ) => {
//     const file = event.target.files?.[0];
//     if (!file || !marketingHeader) return;
...
//   const handleSaveChanges = async () => {
//     try {
//       const [paletteResponse, headerResponse] = await Promise.all([
//         fetch('https://kapperking.runasp.net/api/SuperAdmin/UpdateColorPalette', {
//           method: 'POST',
//           headers: {
//             'Content-Type': 'application/json',
...
//       if (!paletteResponse.ok || !headerResponse.ok) {
//         throw new Error('Failed to save some settings');
//       }
...
//                 <input 
//                   type="file" 
//                   ref={marketingHeaderImageInputRef} 
//                   onChange={(e) => handleFileUpload(e, 'marketingHeaderBgImageUrl')} 
//                   hidden 
