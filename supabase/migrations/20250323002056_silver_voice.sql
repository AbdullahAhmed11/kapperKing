...
DROP POLICY IF EXISTS "Users can manage their own refresh tokens" ON auth.refresh_tokens;
DROP POLICY IF EXISTS "Audit logs are viewable by users" ON auth.audit_log_entries;
