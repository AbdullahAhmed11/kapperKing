/*
  ...
  1. Schema Changes
    ...
    - Fixes refresh token structure with proper foreign key and constraints
    - Sets correct default values for user metadata
  
  2. Security
    - Configures proper permissions for auth schema
