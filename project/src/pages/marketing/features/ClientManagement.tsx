...
import { Users, Star, MessageSquare, Database, CheckCircle, ArrowRight, Heart, TrendingUp } from 'lucide-react';
import { Link } from 'react-router-dom';

const features = [
  {
    title: 'Client Profiles',
    description: 'Comprehensive client profiles with service history, preferences, and notes.',
    icon: Users,
    color: 'from-primary-500 to-primary-600'
  },
  {
    title: 'Loyalty Program',
    description: 'Built-in loyalty program to reward and retain your best clients.',
    icon: Heart,
    color: 'from-pink-500 to-pink-600'
  },
  {
    title: 'Communication Tools',
    description: 'Automated notifications, reminders, and personalized marketing.',
    icon: MessageSquare,
...
const testimonials = [
  {
    content: "The client management system has helped us provide a much more personalized service. Our clients love it!",
    author: "Sarah Thompson",
    role: "Owner, Bella Beauty",
    rating: 5
  },
  {
    content: "The loyalty program has significantly improved our client retention. It's been a game-changer for our business.",
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
              <span className="block">Better client</span>
              <span className="block text-primary-200">relationships</span>
            </h1>
            <p className="mt-6 text-xl text-primary-100 max-w-xl">
              Build lasting relationships with your clients through comprehensive client management tools.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-500">
              Everything you need to build and maintain strong client relationships.
            </p>
          </div>
      ...
      <div className="bg-gradient-to-br from-primary-600 to-primary-800">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
            <span className="block">Ready to improve your client relationships?</span>
